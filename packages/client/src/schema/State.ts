/**
 * ! THIS FILE IS DUPLICATED IN THE SERVER PACKAGE
 * !      packages\server\src\schema\State.ts
 * ! WHEN EDITING, MAKE SURE TO UPDATE THE SERVER VERSION AS WELL (Server is the source of truth)
 */
