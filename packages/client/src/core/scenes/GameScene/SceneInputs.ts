...
import { InputManager } from "../../managers/InputManager"; // Adjusted path
import { CameraManager } from "../../managers/CameraManager"; // Adjusted path
import { Logger } from "@one-button-to-space/shared";
import type { PlayerInputMessage } from "@one-button-to-space/shared";
import type { GameScene } from "./index"; // Use type import for scene reference from local index
import { EntityManager } from "../../managers/EntityManager"; // Adjusted path
import { Player } from "../../entities/Player"; // Adjusted path
...
export class SceneInputs {
  ...
  public initialize(): void {
    Logger.info(LOGGER_SOURCE, "Scene Input Manager Initializing"); // Keep log message for now
  ...
  public destroy(): void {
    Logger.info(LOGGER_SOURCE, "Scene Input Manager Destroying"); // Keep log message for now
